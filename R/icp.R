...
#'
#' @description performs iterative closest point algoritm on two mesh objects
#' @author Stefan Schlager
#'
#' @param mesh1 the mesh object of a shoe from the data set
#' @param mesh2 the mesh object of a shoe from the data set
#' @param iteration the number of iterations to perform
#' @param maxdist maximum distance for closest points to be included for matching.
...
#' @param k integer: number of closest triangles on target that will be searched for hits.
...
#' @return list of alligned mesh object and distance metric
#'
#'
#'
#'
#'
icp <- function(mesh1, mesh2, iterations=3, maxdist=NULL, minclost=50, k=50,subsample=NULL,getTransform=FALSE,pcAlign=FALSE,pcOptim=TRUE,threads=0,weights=NULL) {
